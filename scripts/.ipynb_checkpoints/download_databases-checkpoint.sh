...
mkdir -p /BenchVEP/scripts/suspect/
wget http://www.sbg.bio.ic.ac.uk/~suspect/suspect_package-v1.3.tar.gz -P /BenchVEP/scripts/suspect/
tar -xvf /BenchVEP/scripts/suspect/suspect_package-v1.3.tar.gz -C /BenchVEP/scripts/suspect/
sed "s,/bmm/www/servers/suspect,/BenchVEP/scripts/suspect/suspect_package," /BenchVEP/scripts/suspect/suspect_package/suspect.pl -i
sed "s,/suspect_package/data/,data/," /BenchVEP/scripts/suspect/suspect_package/suspect.pl -i
